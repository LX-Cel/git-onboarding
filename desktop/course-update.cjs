...
assert set(payload['files']) == {'lessons.json', 'advanced.py', 'maintenance.py', 'teamwork.py', 'foundations.py', 'extensions.py', 'access.py', 'capstone.py', 'hosting.py', 'relay.py', 'engine.py'}, 'Unexpected course files'
...
compile(decoded['capstone.py'], 'capstone.py', 'exec')
...
with tempfile.TemporaryDirectory(prefix='course-update-', dir='/opt') as staging:
    ...
    for name in ['foundations.py', 'extensions.py', 'access.py', 'capstone.py', 'hosting.py', 'lessons.json', 'advanced.py', 'maintenance.py', 'teamwork.py', 'relay.py', 'engine.py']:
