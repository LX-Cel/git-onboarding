...
assert set(payload['files']) == {'lessons.json', 'advanced.py', 'maintenance.py', 'teamwork.py', 'hosting.py', 'relay.py', 'engine.py'}, 'Unexpected course files'
...
decoded = {}
for name in ['lessons.json', 'advanced.py', 'maintenance.py', 'teamwork.py', 'hosting.py', 'relay.py', 'engine.py']:
...
with tempfile.TemporaryDirectory(prefix='course-update-', dir='/opt') as staging:
    ...
    for name in ['hosting.py', 'lessons.json', 'advanced.py', 'maintenance.py', 'teamwork.py', 'relay.py', 'engine.py']:
