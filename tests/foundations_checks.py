...
with tempfile.TemporaryDirectory(prefix='foundations-') as directory:
    ...
    expect(e.IDS == {'basics', 'collab', 'recovery'} | e.advanced.IDS | e.maintenance.IDS | e.teamwork.IDS | e.foundations.IDS | e.extensions.IDS, 'all catalog courses implemented')
