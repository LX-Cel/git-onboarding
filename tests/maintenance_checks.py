...
with tempfile.TemporaryDirectory(prefix='maintenance-scenarios-') as directory:
    ...
    expect(e.IDS == {'basics', 'collab', 'recovery'} | e.advanced.IDS | m.IDS | e.teamwork.IDS | e.foundations.IDS | e.extensions.IDS | e.access.IDS | e.capstone.IDS, 'every catalog lesson has an implementation')
